...
if ($rows) { 
  ...
  echo "<tr><td colspan='11'><h2><center>Employee Record</center></h2></td>";
  echo "<tr>";
...
while ($rec=mysqli_fetch_array($sear)) {
  echo "<tr>";
  echo "<td>".$rec['e_id']."</td>";
echo "<td>".$rec['e_firstname']."</td>";
echo "<td>".$rec['e_lastname']."</td>";
echo "<td>".$rec['e_email']."</td>";
echo "<td>".$rec['e_phonenumber']."</td>";
echo "<td>".$rec['e_position']."</td>";
echo "<td>".$rec['e_kebele']."</td>";
