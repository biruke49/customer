...
function displayEmpData() {
    ...
    empRef.on('child_added', function (empData) {
        ...
        new_html += '<td id="finame_'+empData.val().emp_id+'">' + empData.val().First_Name + '</td>';
        new_html += '<td id="laname_'+empData.val().emp_id+'">' + empData.val().Last_Name + '</td>';
        new_html += '<td id="emmail_'+empData.val().emp_id+'">' + empData.val().Email + '</td>';
        new_html += '<td id="hnno'+empData.val().emp_id+'">' + empData.val().House_Number + '</td>';
        new_html += '<td id="phonen_'+empData.val().emp_id+'">' + empData.val().Phone + '</td>';
        new_html += '<td id="kebe'+empData.val().emp_id+'">' + empData.val().Kebele + '</td>';
        new_html += '<td id="wore'+empData.val().emp_id+'">' + empData.val().Woreda + '</td>';
        new_html += '<td id="sci'+empData.val().emp_id+'">' + empData.val().Subcity + '</td>';
        new_html += '<td id="usn'+empData.val().emp_id+'">' + empData.val().Username + '</td>';
        new_html += '<td id="paw'+empData.val().emp_id+'">' + empData.val().Password + '</td>';
...
$(document).on('click', '.updateEmpData', function () {
    ...
    $('#finame_'+emp_id).html(First_Name);
    $('#laname_'+emp_id).html(Last_Name);
    $('#emmail_'+emp_id).html(Email);
    $('#hnno'+emp_id).html(House_Number);
    $('#phonen_'+emp_id).html(Phone);
    $('#kebe'+emp_id).html(Kebele);
    $('#wore'+emp_id).html(Woreda);
    $('#sci'+emp_id).html(Subcity);
    $('#usn'+emp_id).html(Username);
    $('#paw'+emp_id).html(Password);
