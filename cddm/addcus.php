...
<form method="POST">
	<div class="loginbox1">  
        ...
        <form>
          ...
          <p>Last Name</p>
          <input type="text" id="ln" placeholder="Enter Lastname">
          <p>Phone Number</p>
          <input type="text" id="pn" placeholder="Enter Phonenumber">
          <p>Email</p>
          <input type="text" id="em" placeholder="Enter Email">
          <p>Kebele</p>
          <input type="text" id="keb" placeholder="Enter Kebele">
          <p>Woreda</p>
          <input type="text" id="wor" placeholder="Enter Woreda">
          <p>House Number</p>
          <input type="text" id="hno" placeholder="Enter Housenumber">
          <p>Subcity</p>
          <input type="text" id="sc" placeholder="Enter Subcity">
          <p>Username</p>
          <input type="text" id="un" placeholder="Enter Username">
          <p>Password</p>
          <input type="password" id="pw" placeholder="Enter Password"> 
          <p>Personal ID</p>
          <input type="file" id="pid" placeholder="Choose">
          <p>Blue Print</p>
          <input type="file" id="bp" placeholder="Choose">
